...
const OUTLINE = [
  ...
  {n:'02',t:'整体解决方案思路',d:'一门户，N智能体，一引擎，一底座',target:3},
  {n:'03',t:'技术路线与架构实现',d:'六层解构，成熟产品底座支撑快速落地',target:4},
  {n:'04',t:'实施效果与价值评估',d:'合规治理与决策实施效果带来的效率与质量跃迁',target:7},
  {n:'05',t:'核心创新点总结',d:'范式跃迁・架构升级・普惠赋能',target:9},
];
